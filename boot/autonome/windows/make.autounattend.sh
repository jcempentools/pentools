...
WINDOWS_DA_BIOS_MAPA_SUBSTITUICAO=(    
  ...
  '<ProductKey>[[:space:]]*[^<]*[[:space:]]*</ProductKey>|<ProductKey>$$VNTY_SERIAL_WIN$$</ProductKey>'

  # 3. ProductKey com <Key> interno (estrutura completa)
  '<ProductKey>[[:space:]]*<Key>[^<]*</Key>[[:space:]]*<WillShowUI>[^<]*</WillShowUI>[[:space:]]*</ProductKey>|<ProductKey><Key>$$VNTY_SERIAL_WIN$$</Key><WillShowUI>Never</WillShowUI></ProductKey>'
